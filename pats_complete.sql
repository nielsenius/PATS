...
--
-- Name: calculate_overnight_stay(); Type: FUNCTION; Schema: public; Owner: Matthew
--
...
CREATE FUNCTION calculate_overnight_stay() RETURNS trigger
    ...
    DECLARE
        ...
        total_time integer;
    BEGIN
        _treatment_id = currval(pg_get_serial_sequence('treatments', 'id'));
...
ALTER FUNCTION public.calculate_overnight_stay() OWNER TO "Matthew";

--
-- Name: calculate_total_costs(); Type: FUNCTION; Schema: public; Owner: Matthew
--
...
CREATE FUNCTION calculate_total_costs() RETURNS trigger
    ...
    BEGIN
        ...
        FOR r IN SELECT * FROM visit_medicines WHERE visit_id = NEW.visit_id LOOP
            total_cost = total_cost + ((SELECT cost_per_unit FROM medicine_costs mc WHERE mc.medicine_id = r.medicine_id AND mc.end_date IS NULL) * r.units_given * (1 - r.discount));
        END LOOP;
        
        FOR r IN SELECT * FROM treatments WHERE visit_id = NEW.visit_id LOOP
            total_cost = total_cost + ((SELECT cost FROM procedure_costs pc WHERE pc.procedure_id = r.procedure_id AND pc.end_date IS NULL) * (1 - r.discount));
        END LOOP;
...
ALTER FUNCTION public.calculate_total_costs() OWNER TO "Matthew";

--
-- Name: decrease_stock_amount_after_dosage(); Type: FUNCTION; Schema: public; Owner: Matthew
--
...
CREATE FUNCTION decrease_stock_amount_after_dosage() RETURNS trigger
    ...
    BEGIN
        ...
        newest_vm_id = currval(pg_get_serial_sequence('visit_medicines', 'id'));
...
ALTER FUNCTION public.decrease_stock_amount_after_dosage() OWNER TO "Matthew";

--
-- Name: set_end_date_for_medicine_costs(); Type: FUNCTION; Schema: public; Owner: Matthew
--
...
CREATE FUNCTION set_end_date_for_medicine_costs() RETURNS trigger
	...
	DECLARE
        ...
        _medicine_id INTEGER;
	BEGIN
		--get the recently added medicine_costs medicine_id
		most_recent_mc_id = currval(pg_get_serial_sequence('medicine_costs', 'id'));
        _medicine_id = (SELECT medicine_id FROM medicine_costs WHERE id = most_recent_mc_id);
		--update previous medicine_cost's end_date to be today
		UPDATE medicine_costs SET end_date = (current_date) WHERE medicine_id = _medicine_id AND end_date IS NULL AND id <> most_recent_mc_id;
	  RETURN NULL;
	END;
$$;


ALTER FUNCTION public.set_end_date_for_medicine_costs() OWNER TO "Matthew";

--
-- Name: set_end_date_for_procedure_costs(); Type: FUNCTION; Schema: public; Owner: Matthew
--
...
CREATE FUNCTION set_end_date_for_procedure_costs() RETURNS trigger
    ...
    BEGIN
        ...
        most_recent_pc_id = currval(pg_get_serial_sequence('procedure_costs', 'id'));
        _procedure_id = (SELECT procedure_id FROM procedure_costs WHERE id = most_recent_pc_id);
        --update previous procedure's end_date to be today
        UPDATE procedure_costs SET end_date = (current_date) WHERE procedure_id = _procedure_id AND end_date IS NULL AND id <> most_recent_pc_id;
      RETURN NULL;
    END;
$$;


ALTER FUNCTION public.set_end_date_for_procedure_costs() OWNER TO "Matthew";

--
-- Name: verify_that_medicine_is_appropriate_for_pet(integer, integer); Type: FUNCTION; Schema: public; Owner: Matthew
--

CREATE FUNCTION verify_that_medicine_is_appropriate_for_pet(_medicine_id integer, _pet_id integer) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
    DECLARE
        pet_animal_id int;
...
ALTER FUNCTION public.verify_that_medicine_is_appropriate_for_pet(_medicine_id integer, _pet_id integer) OWNER TO "Matthew";

--
-- Name: verify_that_medicine_requested_in_stock(integer, integer); Type: FUNCTION; Schema: public; Owner: Matthew
--
...
ALTER FUNCTION public.verify_that_medicine_requested_in_stock(medicine_id integer, units_needed integer) OWNER TO "Matthew";
...
--
-- Name: animal_medicines; Type: TABLE; Schema: public; Owner: Matthew; Tablespace: 
--
...
ALTER TABLE public.animal_medicines OWNER TO "Matthew";

--
-- Name: animal_medicines_id_seq; Type: SEQUENCE; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.animal_medicines_id_seq OWNER TO "Matthew";

--
-- Name: animal_medicines_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Matthew
--
...
--
-- Name: animals; Type: TABLE; Schema: public; Owner: Matthew; Tablespace: 
--
...
ALTER TABLE public.animals OWNER TO "Matthew";

--
-- Name: animals_id_seq; Type: SEQUENCE; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.animals_id_seq OWNER TO "Matthew";

--
-- Name: animals_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Matthew
--
...
--
-- Name: medicine_costs; Type: TABLE; Schema: public; Owner: Matthew; Tablespace: 
--
...
ALTER TABLE public.medicine_costs OWNER TO "Matthew";

--
-- Name: medicine_costs_id_seq; Type: SEQUENCE; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.medicine_costs_id_seq OWNER TO "Matthew";

--
-- Name: medicine_costs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Matthew
--
...
--
-- Name: medicines; Type: TABLE; Schema: public; Owner: Matthew; Tablespace: 
--
...
CREATE TABLE medicines (
    ...
    CONSTRAINT limit_methods CHECK (((method)::text = ANY ((ARRAY['injection'::character varying, 'oral'::character varying, 'intravenous'::character varying])::text[])))
);


ALTER TABLE public.medicines OWNER TO "Matthew";

--
-- Name: medicine_view; Type: VIEW; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.medicine_view OWNER TO "Matthew";

--
-- Name: medicines_id_seq; Type: SEQUENCE; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.medicines_id_seq OWNER TO "Matthew";

--
-- Name: medicines_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Matthew
--
...
--
-- Name: notes; Type: TABLE; Schema: public; Owner: Matthew; Tablespace: 
--
...
ALTER TABLE public.notes OWNER TO "Matthew";

--
-- Name: notes_id_seq; Type: SEQUENCE; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.notes_id_seq OWNER TO "Matthew";

--
-- Name: notes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Matthew
--
...
--
-- Name: owners; Type: TABLE; Schema: public; Owner: Matthew; Tablespace: 
--
...
CREATE TABLE owners (
    ...
    state character varying DEFAULT 'PA'::character varying NOT NULL,
...
ALTER TABLE public.owners OWNER TO "Matthew";

--
-- Name: owners_id_seq; Type: SEQUENCE; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.owners_id_seq OWNER TO "Matthew";

--
-- Name: owners_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Matthew
--
...
--
-- Name: pets; Type: TABLE; Schema: public; Owner: Matthew; Tablespace: 
--
...
ALTER TABLE public.pets OWNER TO "Matthew";

--
-- Name: visits; Type: TABLE; Schema: public; Owner: Matthew; Tablespace: 
--
...
ALTER TABLE public.visits OWNER TO "Matthew";

--
-- Name: owners_view; Type: VIEW; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.owners_view OWNER TO "Matthew";

--
-- Name: pets_id_seq; Type: SEQUENCE; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.pets_id_seq OWNER TO "Matthew";

--
-- Name: pets_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Matthew
--
...
--
-- Name: procedure_costs; Type: TABLE; Schema: public; Owner: Matthew; Tablespace: 
--
...
ALTER TABLE public.procedure_costs OWNER TO "Matthew";

--
-- Name: procedure_costs_id_seq; Type: SEQUENCE; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.procedure_costs_id_seq OWNER TO "Matthew";

--
-- Name: procedure_costs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Matthew
--
...
--
-- Name: procedures; Type: TABLE; Schema: public; Owner: Matthew; Tablespace: 
--
...
ALTER TABLE public.procedures OWNER TO "Matthew";

--
-- Name: procedures_id_seq; Type: SEQUENCE; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.procedures_id_seq OWNER TO "Matthew";

--
-- Name: procedures_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Matthew
--
...
--
-- Name: treatments; Type: TABLE; Schema: public; Owner: Matthew; Tablespace: 
--
...
CREATE TABLE treatments (
    ...
    CONSTRAINT treatment_discount_range CHECK (((discount >= (0.00)::double precision) AND (discount <= (1.00)::double precision)))
);


ALTER TABLE public.treatments OWNER TO "Matthew";

--
-- Name: treatments_id_seq; Type: SEQUENCE; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.treatments_id_seq OWNER TO "Matthew";

--
-- Name: treatments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Matthew
--
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: Matthew; Tablespace: 
--
...
ALTER TABLE public.users OWNER TO "Matthew";
...
ALTER TABLE public.users_id_seq OWNER TO "Matthew";
...
--
-- Name: visit_medicines; Type: TABLE; Schema: public; Owner: Matthew; Tablespace: 
--
...
CREATE TABLE visit_medicines (
    ...
    discount real DEFAULT 0.00 NOT NULL,
    CONSTRAINT med_discount_range CHECK (((discount >= (0.00)::double precision) AND (discount <= (1.00)::double precision)))
);


ALTER TABLE public.visit_medicines OWNER TO "Matthew";

--
-- Name: visit_medicines_id_seq; Type: SEQUENCE; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.visit_medicines_id_seq OWNER TO "Matthew";

--
-- Name: visit_medicines_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Matthew
--
...
--
-- Name: visits_id_seq; Type: SEQUENCE; Schema: public; Owner: Matthew
--
...
ALTER TABLE public.visits_id_seq OWNER TO "Matthew";

--
-- Name: visits_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Matthew
--
...
--
-- Data for Name: animal_medicines; Type: TABLE DATA; Schema: public; Owner: Matthew
--
...
--
-- Name: animal_medicines_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Matthew
--
...
--
-- Data for Name: animals; Type: TABLE DATA; Schema: public; Owner: Matthew
--
...
--
-- Name: animals_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Matthew
--
...
--
-- Data for Name: medicine_costs; Type: TABLE DATA; Schema: public; Owner: Matthew
--
...
--
-- Name: medicine_costs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Matthew
--
...
--
-- Data for Name: medicines; Type: TABLE DATA; Schema: public; Owner: Matthew
--
...
--
-- Name: medicines_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Matthew
--
...
--
-- Data for Name: notes; Type: TABLE DATA; Schema: public; Owner: Matthew
--
...
--
-- Name: notes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Matthew
--
...
--
-- Data for Name: owners; Type: TABLE DATA; Schema: public; Owner: Matthew
--
...
--
-- Name: owners_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Matthew
--
...
--
-- Data for Name: pets; Type: TABLE DATA; Schema: public; Owner: Matthew
--
...
--
-- Name: pets_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Matthew
--
...
--
-- Data for Name: procedure_costs; Type: TABLE DATA; Schema: public; Owner: Matthew
--
...
--
-- Name: procedure_costs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Matthew
--
...
--
-- Data for Name: procedures; Type: TABLE DATA; Schema: public; Owner: Matthew
--
...
--
-- Name: procedures_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Matthew
--
...
--
-- Data for Name: treatments; Type: TABLE DATA; Schema: public; Owner: Matthew
--
...
--
-- Name: treatments_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Matthew
--
...
--
-- Data for Name: visit_medicines; Type: TABLE DATA; Schema: public; Owner: Matthew
--
...
--
-- Name: visit_medicines_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Matthew
--
...
--
-- Data for Name: visits; Type: TABLE DATA; Schema: public; Owner: Matthew
--
...
1950	173	2014-12-07	39	f	36700
\.


--
-- Name: visits_id_seq; Type: SEQUENCE SET; Schema: public; Owner: Matthew
--
...
--
-- Name: animal_medicines_pkey; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: animals_pkey; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: medicine_costs_pkey; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: medicines_pkey; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: notes_pkey; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: owners_pkey; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: pets_pkey; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: procedure_costs_pkey; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: procedures_pkey; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: treatments_pkey; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: users_pkey; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: users_username_key; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: visit_medicines_pkey; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: visits_pkey; Type: CONSTRAINT; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: am_animal_id_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX am_animal_id_idx ON animal_medicines USING btree (animal_id);


--
-- Name: am_medicine_id_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX am_medicine_id_idx ON animal_medicines USING btree (medicine_id);


--
-- Name: mc_end_date_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX mc_end_date_idx ON medicine_costs USING btree (end_date);


--
-- Name: mc_medicine_id_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX mc_medicine_id_idx ON medicine_costs USING btree (medicine_id);


--
-- Name: med_description_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX med_description_idx ON medicines USING gin (to_tsvector('english'::regconfig, description));


--
-- Name: notes_notable_id_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX notes_notable_id_idx ON notes USING btree (notable_id);


--
-- Name: notes_notable_type_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX notes_notable_type_idx ON notes USING btree (notable_type);


--
-- Name: notes_user_id_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: pc_end_date_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX pc_end_date_idx ON procedure_costs USING btree (end_date);


--
-- Name: pc_procedure_id_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX pc_procedure_id_idx ON procedure_costs USING btree (procedure_id);


--
-- Name: pets_animal_id_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX pets_animal_id_idx ON pets USING btree (animal_id);


--
-- Name: pets_owner_id_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--
...
--
-- Name: treatments_procedure_id_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX treatments_procedure_id_idx ON treatments USING btree (procedure_id);


--
-- Name: treatments_visit_id_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX treatments_visit_id_idx ON treatments USING btree (visit_id);


--
-- Name: visits_pet_id_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX visits_pet_id_idx ON visits USING btree (pet_id);


--
-- Name: vm_medicine_id_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX vm_medicine_id_idx ON visit_medicines USING btree (medicine_id);


--
-- Name: vm_visit_id_idx; Type: INDEX; Schema: public; Owner: Matthew; Tablespace: 
--

CREATE INDEX vm_visit_id_idx ON visit_medicines USING btree (visit_id);


--
-- Name: set_end_date_for_previous_medicine_cost; Type: TRIGGER; Schema: public; Owner: Matthew
--
...
--
-- Name: set_end_date_for_previous_procedure_cost; Type: TRIGGER; Schema: public; Owner: Matthew
--
...
--
-- Name: update_overnight_stay_flag; Type: TRIGGER; Schema: public; Owner: Matthew
--
...
--
-- Name: update_stock_amount_for_medicines; Type: TRIGGER; Schema: public; Owner: Matthew
--
...
--
-- Name: update_total_costs_for_medicines_changes; Type: TRIGGER; Schema: public; Owner: Matthew
--
...
--
-- Name: update_total_costs_for_treatments_changes; Type: TRIGGER; Schema: public; Owner: Matthew
--
...
--
-- Name: animal_id_am_fk; Type: FK CONSTRAINT; Schema: public; Owner: Matthew
--

ALTER TABLE ONLY animal_medicines
    ADD CONSTRAINT animal_id_am_fk FOREIGN KEY (animal_id) REFERENCES animals(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: animal_id_pets_fk; Type: FK CONSTRAINT; Schema: public; Owner: Matthew
--

ALTER TABLE ONLY pets
    ADD CONSTRAINT animal_id_pets_fk FOREIGN KEY (animal_id) REFERENCES animals(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: medicine_id_am_fk; Type: FK CONSTRAINT; Schema: public; Owner: Matthew
--

ALTER TABLE ONLY animal_medicines
    ADD CONSTRAINT medicine_id_am_fk FOREIGN KEY (medicine_id) REFERENCES medicines(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: medicine_id_mc_fk; Type: FK CONSTRAINT; Schema: public; Owner: Matthew
--

ALTER TABLE ONLY medicine_costs
    ADD CONSTRAINT medicine_id_mc_fk FOREIGN KEY (medicine_id) REFERENCES medicines(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: medicine_id_vm_fk; Type: FK CONSTRAINT; Schema: public; Owner: Matthew
--

ALTER TABLE ONLY visit_medicines
    ADD CONSTRAINT medicine_id_vm_fk FOREIGN KEY (medicine_id) REFERENCES medicines(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: owner_id_pets_fk; Type: FK CONSTRAINT; Schema: public; Owner: Matthew
--

ALTER TABLE ONLY pets
    ADD CONSTRAINT owner_id_pets_fk FOREIGN KEY (owner_id) REFERENCES pets(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: pet_id_visits_fk; Type: FK CONSTRAINT; Schema: public; Owner: Matthew
--

ALTER TABLE ONLY visits
    ADD CONSTRAINT pet_id_visits_fk FOREIGN KEY (pet_id) REFERENCES pets(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: procedure_id_pc_fk; Type: FK CONSTRAINT; Schema: public; Owner: Matthew
--

ALTER TABLE ONLY procedure_costs
    ADD CONSTRAINT procedure_id_pc_fk FOREIGN KEY (procedure_id) REFERENCES procedures(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: procedure_id_treatments_fk; Type: FK CONSTRAINT; Schema: public; Owner: Matthew
--

ALTER TABLE ONLY treatments
    ADD CONSTRAINT procedure_id_treatments_fk FOREIGN KEY (procedure_id) REFERENCES procedures(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: user_id_notes_fk; Type: FK CONSTRAINT; Schema: public; Owner: Matthew
--

ALTER TABLE ONLY notes
    ADD CONSTRAINT user_id_notes_fk FOREIGN KEY (user_id) REFERENCES users(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: visit_id_treatments_fk; Type: FK CONSTRAINT; Schema: public; Owner: Matthew
--

ALTER TABLE ONLY treatments
    ADD CONSTRAINT visit_id_treatments_fk FOREIGN KEY (visit_id) REFERENCES visits(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: visit_id_vm_fk; Type: FK CONSTRAINT; Schema: public; Owner: Matthew
--

ALTER TABLE ONLY visit_medicines
    ADD CONSTRAINT visit_id_vm_fk FOREIGN KEY (visit_id) REFERENCES visits(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: treatments; Type: ACL; Schema: public; Owner: Matthew
--

REVOKE ALL ON TABLE treatments FROM PUBLIC;
REVOKE ALL ON TABLE treatments FROM "Matthew";
GRANT ALL ON TABLE treatments TO "Matthew";
...
REVOKE ALL ON TABLE users FROM "Matthew";
GRANT ALL ON TABLE users TO "Matthew";
GRANT SELECT ON TABLE users TO PUBLIC;


--
-- Name: visit_medicines; Type: ACL; Schema: public; Owner: Matthew
--

REVOKE ALL ON TABLE visit_medicines FROM PUBLIC;
REVOKE ALL ON TABLE visit_medicines FROM "Matthew";
GRANT ALL ON TABLE visit_medicines TO "Matthew";
